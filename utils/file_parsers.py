...
from settings import REGEX_PATTERNS_FOR_XLSX_HEADERS, ROOT_FOLDER, COPIES_FOLDER, URLS, DOWNLOADS_FOLDER
...
def convert_xls_to_xlsx(path_to_source_file, path_to_destination_file, engine_for_source=None):
